...
c) for both - 1Chip-03 and SNES Mini/Jr.  
 - R41: 8.66kOhm resistor 0603 package (0.125W, 1% tolerance should be fine) [2]  
 - R42: 1.4kOhm resistor 0603 package (0.125W, 1% tolerance should be fine) [2]  
 - C43: 220uF/6.3V or 330uF/6.3V tantalum capacitor type-D package (typical: 7.30mm x 4.30mm) [2,3]  
 - R43: 75Ohm resistor 0603 package (0.125W, 1% tolerance should be fine) [2,3]  
...
[2]  
These components are for csync restoration. The R41 (common components) is needed on all boards to leave the connected pin of the THS7374 not floating.  
...
Look at OSHPark: https://oshpark.com/shared_projects/pY8OFuno
